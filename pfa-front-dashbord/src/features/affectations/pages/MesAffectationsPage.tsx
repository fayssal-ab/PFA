							...
							>
								<div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6">
									<div className="flex-1 min-w-0">
										...
										{a.commentaire && (
											<div className="flex items-start gap-3 mt-5 bg-indigo-500/10 border border-indigo-500/20 rounded-2xl px-4 py-3">
												...
												<div>
													<p className="text-[12px] font-semibold text-indigo-300 mb-1">
														Commentaire
													</p>
